...
int main()
{
	...
	pIn->GetPointClicked(x, y);	//Wait for any click
								...
								/// 2.3- Drawing Ladders ///
								/// ====================
	pOut->PrintMessage("2.3- Drawing (Ladders) Test,  Click to continue");               // MOstafa
	pIn->GetPointClicked(x, y);	//Wait for any click
	...
	pIn->GetUserAction();
	///       a ladder from end_34 to start_1 declared above (invalid) ---------------------------------------------------------- Wrong
	...
	pIn->GetPointClicked(x, y);	//Wait for any click
								...
								/// 2.4- Drawing Snakes ///
								/// ====================
	pOut->PrintMessage("2.4- Drawing (Snakes) Test,  Click to continue");                        //Micheal
	pIn->GetPointClicked(x, y);	//Wait for any click
